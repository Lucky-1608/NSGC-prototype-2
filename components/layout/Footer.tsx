                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mb-2">
                            Empowering NxtWave students through effective leadership, representation, and community building.
                        </p>
                        <ul className="space-y-2 text-sm">
                            <li>University Campus, Block A</li>
                            <li><a href="mailto:contact@nsgc.edu" className="hover:text-cyan-500">contact@nsgc.edu</a></li>
