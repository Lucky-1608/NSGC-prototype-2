    ...
    ({ className, ...props }, ref) => {
        return (
            <div className="relative w-full group">
                ...
                <textarea
                    className={cn(
                        "flex min-h-[80px] w-full bg-black/40 border border-blue-500/20 px-3 py-2 text-sm text-blue-400 font-mono shadow-[inset_0_0_15px_rgba(59,130,246,0.05)] placeholder:text-blue-500/30 focus-visible:outline-none focus:border-blue-500/50 focus:bg-blue-500/10 transition-all rounded-sm",
                        className
                    )}
                    ref={ref}
                    {...props}
